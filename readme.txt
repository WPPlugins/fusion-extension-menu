=== Fusion Page Builder : Extension - Menu ===
Contributors: agencydominion
Tags: admin, custom, builder, page builder, layout builder, layout, page, columns, multi-column, grid, responsive, shortcode, bootstrap, menu, header, footer, mobile, hamburger
...
2. Install Fusion : Extension - Menu through the WordPress plugins screen, or upload the plugin files to the `/wp-content/plugins` directory.
3. Activate Fusion : Extension - Menu through the 'Plugins' screen in WordPress
4. Visit the Fusion knowledge base and user guide at <http://agencydominion.helpscoutdocs.com/>

== Frequently Asked Questions ==

= Does the Fusion : Extension - Menu plugin require the Fusion core plugin to function? =

Yes. The Fusion : Extension - Menu plugin is an extension for adding a Menu element to Fusion. The Fusion core plugin must be installed for this plugin to function. You can get Fusion [here](https://wordpress.org/plugins/fusion/).
...
= 1.1.10 =
* Inline Layout: Update mobile styles so that buttons are stacked.
...
= 1.1.7 =
* Minor code quality update

= 1.1.6 =
* Main Menu Layout: Update style and functionality of mobile view for a better default appearance and for better customizability.

= 1.1.5 =
* Update logic for hiding and showing edit modal sections in admin.

= 1.1.4 =
* Update default button style from None to Bootstrap Default for Inline layout.

= 1.1.3 =
* Localization updates.
* Code quality updates.
* Add button size option to inline layout.
...
= 1.0.1 =
* Main Menu layout CSS updates.

= 1.0.0 =
* Fusion : Extension - Menu initial launch.
